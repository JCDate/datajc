...
public class EstructuraGUI extends javax.swing.JFrame {
    ...
    public EstructuraGUI(Usuarios mod) throws SQLException, ClassNotFoundException{
        ...
        try { 
            ...
            PreparedStatement pst = cn.prepareStatement("INSERT INTO datoslistaprecios (datoslistaprecios.componente, datoslistaprecios.cr, datoslistaprecios.calibre, datoslistaprecios.blank_kg) SELECT estructura.componente, estructura.CR, estructura.calibre, consumoyantecedentes.consumo_uni FROM estructura, consumoyantecedentes WHERE consumoyantecedentes.componente_CA=estructura.componente AND NOT EXISTS ( SELECT datoslistaprecios.componente FROM datoslistaprecios WHERE datoslistaprecios.componente = estructura.componente AND datoslistaprecios.componente=consumoyantecedentes.componente_CA)");
            pst.executeUpdate();
            
            //Modificar calibre de datos lista de precios
            PreparedStatement pst2 = cn.prepareStatement("UPDATE datoslistaprecios SET datoslistaprecios.calibre=(SELECT estructura.calibre FROM estructura WHERE estructura.componente= datoslistaprecios.componente )");
            pst2.executeUpdate();
            
            //Modificar kg/back de datos lista de precios
            PreparedStatement pst5 = cn.prepareStatement("UPDATE datoslistaprecios SET datoslistaprecios.blank_kg=(SELECT estructura.peso_estamp FROM estructura WHERE estructura.componente= datoslistaprecios.componente )");
            pst5.executeUpdate();
            
            //componente datos tecnicos mp
            PreparedStatement pst3 = cn.prepareStatement("INSERT INTO datostecnicosmp (datostecnicosmp.componente) SELECT datoslistaprecios.componente FROM datoslistaprecios WHERE NOT EXISTS ( SELECT datostecnicosmp.componente FROM datostecnicosmp WHERE datostecnicosmp.componente = datoslistaprecios.componente)");
            pst3.executeUpdate();
            
            //componente calculos teoricos
            PreparedStatement pst4 = cn.prepareStatement("INSERT INTO calculosteoricos(calculosteoricos.componente) SELECT datoslistaprecios.componente FROM datoslistaprecios WHERE NOT EXISTS ( SELECT calculosteoricos.componente FROM calculosteoricos WHERE calculosteoricos.componente = datoslistaprecios.componente)");
            pst4.executeUpdate();
    ...
    private void EstructuraGUI(){
        try{
            ...
            this.estructura = this.estructura_servicio.recuperarTodas(Conexion.obtener());
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        if(evt.getKeyCode() == com.sun.glass.events.KeyEvent.VK_ENTER){
            try {
                ...
                consulta = cn.prepareStatement("UPDATE estructura SET um='"+um+"',OP='"+OP+"', calibre='"+calibre+"' WHERE componente='"+componente+"'");
