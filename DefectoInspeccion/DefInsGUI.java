...
public class DefInsGUI extends javax.swing.JFrame {
    private final DefIns_servicio defIns_servicio = new DefIns_servicio();
    private List<DefInsM> defIns;
    ...
    public DefInsGUI() throws SQLException, ClassNotFoundException {
    ...
    public DefInsGUI(Usuarios mod) throws SQLException, ClassNotFoundException{
        this.cn = Conexion.obtener();
        initComponents();
        this.mod = mod;
        this.setResizable(false);
    ...
    private void CRs(){
        try{
            this.defIns = this.defIns_servicio.recuperarTodas(Conexion.obtener());
            
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            for(int i = 0; i < this.defIns.size(); i++){
                dtm.addRow(new Object[]{
                    this.defIns.get(i).getId(),
                    this.defIns.get(i).getComponente(),
                    this.defIns.get(i).getDefecto(),
                    this.defIns.get(i).getOperacion()
                });
            }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 150, 40));

        jLabel3.setFont(new java.awt.Font("Wide Latin", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("DEFECTO INSPECCIÓN");
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 150, 40));
        ...
        getContentPane().add(jtxtfiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 130, 180, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jc/img/buscar.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 130, 30, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 1150, 440));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 150, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DefInsGUI.this.dispose();
        AgregarDefIns agregar = new AgregarDefIns(mod);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       int fila_seleccionada = jTable1.getSelectedRow();
        if(fila_seleccionada >= 0){
            try {
                DefInsGUI.this.dispose();
                ModificarDefIns modificar = new ModificarDefIns(this.defIns.get(fila_seleccionada),mod);
                modificar.setVisible(true);
                modificar.setLocationRelativeTo(null);
            } catch (SQLException ex) {
                Logger.getLogger(DefInsGUI.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(DefInsGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DefInsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
