...
public class toExcel {
  ...
  File file = new File("AntecedentesFamilia.xls");
 ...
 */
    public void WriteExcelAntecedentesF()
    {
        int row=1;
        ...
        try {
            ...
            workbook.createSheet( "AntecedentesFamilia", 0 );
        ...
        //Consulta SQL 
        String sql = "SELECT componente, familia FROM antecedentesfamilia ORDER BY componente ASC ";
         try{
             ...
             System.out.println(  "obteniendo registros.....Listo"  );
              ...
              while(res.next())
              {
                  ...
                  Label fam= new Label( 1 , 0, "FAMILIA" , cf );                  
                                    
                  Label componente  = new Label( 0 , row, res.getString( "componente" ) , cf );                  
                  Label familia= new Label( 1 , row, res.getString( "familia" ) , cf );                  

                  row ++;                  
                 try {
                     excelSheet.addCell( comp );
                     excelSheet.addCell( fam );
                     
                     excelSheet.addCell( componente );
                     excelSheet.addCell( familia );
