...
public class ModificarInventario extends javax.swing.JFrame {
    ...
    public ModificarInventario(InventarioM p_CA, Usuarios mod){
        initComponents();
        this.inventario = p_CA;
        this.mod=mod;
        this.setDefaultCloseOperation(0);
        
        jTextField1.setText(this.inventario.getCalibre());
        jTextField10.setText(this.inventario.getDescripcion());
        jTextField2.setText(this.inventario.getNum_calibre());
        jTextField3.setText(this.inventario.getUnidad());
        jTextField4.setText(this.inventario.getMilesimas());
        jTextField5.setText(this.inventario.getExistencia());
        jTextField6.setText(Float.toString(this.inventario.getKgs()));
        jTextField7.setText(this.inventario.getTolerancia());
        jTextField8.setText(Float.toString(this.inventario.getPeso_hoja()));
        jTextField9.setText(this.inventario.getObservaciones());
    }
    ...
    private void guardar(){
        ...
        if(!calibre.trim().equals("")){
            ...
            try{
                this.inventario_servicio.modificar(Conexion.obtener(), this.inventario);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 310, 50));

        jLabel7.setFont(new java.awt.Font("Wide Latin", 1, 24)); // NOI18N
        jLabel7.setText("INVENTARIO");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 50, 340, 50));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 420, 190, -1));
        ...
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 180, 210, -1));
        ...
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 420, 100, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 370, 190, -1));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel15.setText("UNIDAD:");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 370, 100, -1));
        ...
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 240, 190, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(ModificarInventario.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ModificarInventario.class.getName()).log(Level.SEVERE, null, ex);
        }
