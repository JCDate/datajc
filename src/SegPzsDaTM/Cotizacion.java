...
public class Cotizacion extends javax.swing.JFrame {
    ...
    public Cotizacion() throws SQLException, ClassNotFoundException {
    ...
    public Cotizacion(OrdenesProdM p_op,Usuarios mod) throws SQLException, ClassNotFoundException{
        this.cn = Conexion.obtener();
        initComponents();
        this.mod=mod;
        this.op = p_op;
        ...
        jTextField4.setText(this.op.getTroquel());
 ...
 @Override
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 170, 190, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            String troquel = jTextField4.getText();
            ...
            try{
                if(this.co_servicio.existeComponente(jTextField1.getText())== 0 && this.sol_servicio.existeC(jTextField1.getText())== 0)
                {
                    ...
                    CompProdMayorGUI ant = new CompProdMayorGUI(mod);
                    ant.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            Cotizacion.this.dispose();
            CompProdMayorGUI tr = new CompProdMayorGUI(mod);
            tr.setVisible(true);
