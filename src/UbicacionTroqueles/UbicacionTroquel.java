...
public class UbicacionTroquel extends javax.swing.JFrame {
    ...
    public UbicacionTroquel() throws SQLException, ClassNotFoundException {
        this.cn = Conexion.obtener();
        initComponents();
        this.setResizable(false);
        this.setDefaultCloseOperation(0);
        this.UbicacionTroquel();
        jButton4.setVisible(false);
        
        //Boton Exportar Ubicacion Troquel
        jButton5.setFocusPainted(false);
        jButton5.setBorderPainted(false);
        //jButton5.setContentAreaFilled(false);

    }
    public UbicacionTroquel(Usuarios mod) throws SQLException, ClassNotFoundException{
        this.cn = Conexion.obtener();
        initComponents();
        this.mod = mod;
        this.setResizable(false);
    ...
    private void UbicacionTroquel(){
        try{
            
            this.ub = this.ubicacionTroquel_servicio.recuperarTodas(Conexion.obtener());
            
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            for(int i = 0; i < this.ub.size(); i++){
                dtm.addRow(new Object[]{
                    this.ub.get(i).getTroquel(),
                    this.ub.get(i).getUbicacion()    
                });
            }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 180, 480, 430));
        ...
        jLabel3.setText("UBICACIÓN DE ");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 40, -1, 30));

        jLabel4.setFont(new java.awt.Font("Wide Latin", 1, 24)); // NOI18N
        jLabel4.setText("TROQUELES ");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 80, -1, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 150, 40));
        ...
        getContentPane().add(jtxtfiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 150, 180, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jc/img/buscar.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, 30, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 570, 130, 40));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 150, 40));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 10, 60, 60));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        UbicacionTroquel.this.dispose();
        AgregarUbicacionTroquel ubT = new AgregarUbicacionTroquel(mod);
        ubT.setVisible(true);
        ubT.setLocationRelativeTo(null);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fila_seleccionada >= 0){
            UbicacionTroquel.this.dispose();
            ModificarUbicacionTroquel modificar = new ModificarUbicacionTroquel(this.ub.get(fila_seleccionada),mod);
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        if(evt.getKeyCode() == com.sun.glass.events.KeyEvent.VK_ENTER){
            try {
                String troquel = jTable1.getValueAt(jTable1.getSelectedRow(),0).toString();
                String ubicacion = jTable1.getValueAt(jTable1.getSelectedRow(),1).toString();
                PreparedStatement consulta;
                consulta = cn.prepareStatement("UPDATE ubicaciontroquel SET ubicacion='"+ubicacion+"' WHERE troquel='"+troquel+"'");
                consulta.executeUpdate();
                JOptionPane.showMessageDialog(this, "MODIFICACIÓN EXITOSA");
            } catch (SQLException ex) {
                Logger.getLogger(UbicacionTroquel.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UbicacionTroquel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new UbicacionTroquel().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(UbicacionTroquel.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(UbicacionTroquel.class.getName()).log(Level.SEVERE, null, ex);
