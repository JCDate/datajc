...
public class ModificarEstructura extends javax.swing.JFrame {
    ...
    public ModificarEstructura(EstructuraM p_estruc,Usuarios mod){
        initComponents();
        this.estructura = p_estruc;
        this.mod= mod;
        this.setDefaultCloseOperation(0);
        
        jTextField1.setText(this.estructura.getComponente());
        jTextField3.setText(this.estructura.getUm());
        jTextField4.setText(String.valueOf(this.estructura.getOp()));
        jTextField6.setText(this.estructura.getCR());
        jTextField7.setText(this.estructura.getCalibre());
        jTextField8.setText(Float.toString(this.estructura.getPeso_estamp()));
    ...
    private void guardar(){
        ...
        String peso_estamp = jTextField8.getText();
            ...
            try{
                this.estructura_servicio.modificar(Conexion.obtener(), this.estructura);
                ModificarEstructura.this.dispose();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 190, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 190, 140, -1));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 30, 300, 50));

        jLabel7.setFont(new java.awt.Font("Wide Latin", 1, 24)); // NOI18N
        jLabel7.setText("ESTRUCTURA");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 60, 370, 50));
        ...
        jLabel9.setText("C/R:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 160, 120, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 240, 190, -1));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 330, 190, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setText("OP:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, 100, -1));
        ...
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 160, 210, 30));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setText("CALIBRE:");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 240, 120, -1));
        ...
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 240, 210, 30));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setText("PESO ESTAMPA:");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 330, 120, -1));
        ...
        getContentPane().add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 330, 210, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(ModificarEstructura.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ModificarEstructura.class.getName()).log(Level.SEVERE, null, ex);
        }
