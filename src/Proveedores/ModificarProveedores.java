...
public class ModificarProveedores extends javax.swing.JFrame {
    ...
    public ModificarProveedores(ProveedoresM p_prov,Usuarios mod){
        initComponents();
        this.setResizable(false);
        this.setDefaultCloseOperation(0);
        this.prov = p_prov;
        ...
        jTextField1.setText(this.prov.getNombre());
        ...
        jTextField6.setText(this.prov.getCalibre());                
    }
    ...
    private void guardar(){
        ...
        if(!nombre.trim().equals("")){
            ...
            try{
                ...
                this.proveedores_servicio.modificar(Conexion.obtener(), this.prov);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 240, 190, -1));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 20, 320, 50));

        jLabel7.setFont(new java.awt.Font("Wide Latin", 1, 24)); // NOI18N
        jLabel7.setText("PROVEEDORES");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 50, 390, 50));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 160, 120, -1));
        ...
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 150, 190, -1));
