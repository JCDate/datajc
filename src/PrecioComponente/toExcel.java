...
public class toExcel {
  ...
  File file = new File("PrecioComponentes.xls");
 ...
 */
    public void WriteExcelPrecioC()
    {
        ...
        try {
            ...
            workbook.createSheet( "PrecioComponentes", 0 );
        ...
        //Consulta SQL 
        String sql = "SELECT componente, precioU FROM preciocomponente ";
         try{
             ...
             System.out.println(  "obteniendo registros.....Listo"  );
              ...
              while(res.next())
              {
                  ...
                  Label pre= new Label( 1 , 0, "PRECIO U." , cf );                  
                                    
                  Label componente  = new Label( 0 , row, res.getString( "componente" ) , cf );                  
                  Number precio= new Number( 1 , row, res.getFloat( "precioU" ) , cf ); 
