...
public class DimensionesGUI extends javax.swing.JFrame {
    private final Dim_servicio dim_servicio = new Dim_servicio();
    private List<DimM> dim;
    ...
    public DimensionesGUI() throws SQLException, ClassNotFoundException {
        ...
        //Boton Exportar Dimensiones
        jButton5.setFocusPainted(false);
        jButton5.setBorderPainted(false);
        //jButton5.setContentAreaFilled(false);
        
    }
    public DimensionesGUI(Usuarios mod) throws SQLException, ClassNotFoundException{
        this.cn = Conexion.obtener();
        initComponents();
        this.mod = mod;
        this.setResizable(false);
    ...
    private void DimGUI(){
        try{
            ...
            this.dim = this.dim_servicio.recuperarTodas(Conexion.obtener());
            
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            for(int i = 0; i < this.dim.size(); i++){
                dtm.addRow(new Object[]{
                    this.dim.get(i).getComponente(),
                    this.dim.get(i).getCr(),
                    this.dim.get(i).getCalibre(),
                    this.dim.get(i).getDiaEx(),
                    this.dim.get(i).getDiaInt(),
                    this.dim.get(i).getAltura()
                });
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COMPONENTE", "C/R", "CALIBRE", "DIA. EXT.", "DIA. INT. ", "ALTURA"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 1250, 480));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 0, 60, 60));

        jLabel4.setText("EXPORTAR");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 60, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            DimensionesGUI.this.dispose();
            AgregarDim vista = new AgregarDim(mod);
            vista.setVisible(true);
            vista.setLocationRelativeTo(null);
        } catch (SQLException ex) {
            Logger.getLogger(DimensionesGUI.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(DimensionesGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fila_seleccionada >= 0){
            DimensionesGUI.this.dispose();
            ModificarDim modificar = new ModificarDim(this.dim.get(fila_seleccionada),mod);
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
       if(evt.getKeyCode() == com.sun.glass.events.KeyEvent.VK_ENTER){
            try {
                ...
                String diaEx = jTable1.getValueAt(jTable1.getSelectedRow(),3).toString();
                String diaInt = jTable1.getValueAt(jTable1.getSelectedRow(),4).toString();
                String altura = jTable1.getValueAt(jTable1.getSelectedRow(),5).toString();
                
                PreparedStatement consulta;
                consulta = cn.prepareStatement("UPDATE dim SET diaEx='"+diaEx+"',diaInt='"+diaInt+"', altura='"+altura+"' WHERE componente='"+componente+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DimensionesGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new DimensionesGUI().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(DimensionesGUI.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(DimensionesGUI.class.getName()).log(Level.SEVERE, null, ex);
