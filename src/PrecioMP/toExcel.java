 ...
 */
    public void WriteExcelPrecioMP()
    {
        ...
        //Consulta SQL 
        String sql = "SELECT calibre, pesoUnitario,moneda FROM preciomp ";
         try{
             ...
             System.out.println(  "obteniendo registros.....Listo"  );
              ...
              while(res.next())
              {
                  ...
                  Label pre= new Label( 1 , 0, "PESO U." , cf );  
                  Label mon= new Label( 2 , 0, "MONEDA" , cf ); 
                                    
                  Label calibre  = new Label( 0 , row, res.getString( "calibre" ) , cf );                  
                  Label precio= new Label( 1 , row, res.getString( "pesoUnitario" ) , cf );
                  Label moneda= new Label( 2 , row, res.getString( "moneda" ) , cf );
